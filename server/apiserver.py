...
import cv2
import sys
sys.path.append('C:/Users/zahwa/OneDrive/Desktop/ai/Code_penerapan_AI')

from backend_classification.test_classification import ImageClassifierTester

app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = 'C:/Users/user/OneDrive/Desktop/ai/airecface/server/uploads_images'  # Sesuaikan dengan lokasi penyimpanan Anda
app.config['PREPROCESS_FOLDER'] = 'C:/Users/user/OneDrive/Desktop/ai/airecface/server/preprocess_images'  # Folder untuk hasil pengolahan citra
...
def processed_image(file_path):
    MODEL_DIR = 'C:/Users/user/OneDrive/Desktop/ai/airecface/backend_classification/model'
    FEATURE_DIR = 'C:/Users/user/OneDrive/Desktop/ai/airecface/backend_classification/fitur'
